...
:--|:--|:--|:-:
1.| Apply the concept of average and RMS voltage calculation to calculate these values. | Calculate | 1 A Single phase half-wave controlled rectifire is used to feed the DC power to resistive load. If this circuit is fired at angle α = 30°, What will be the shape of output current: <br>
A. A full wave similar to input Supply <br>
B. A half wave opposite to output Voltage <br> 
C. A half wave similar to output voltage <br> 
D. A half wave with 30° phase lag to output voltage 
